...
class RowUnitTest extends KernelTestCase
{
    ...
    public function testWin()
    {
        ...
        $this->assertTrue($this->victoryCalculationService->isRowWin(2, $game, $selectedCell, $markedCells));
    }
    ...
    public function testNotWin()
    {
        ...
        $markedCells = $this->selectedCellRepo->getFromRow($game->getId(), SelectedCell::SYMBOL_X, $selectedCell->getRow());
        $this->assertFalse($this->victoryCalculationService->isRowWin(2, $game, $selectedCell, $markedCells));
    }
}
